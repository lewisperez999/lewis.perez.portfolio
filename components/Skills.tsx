...
const skillGroups: SkillGroup[] = [
  { title: "Programming Languages", items: ["Java 8+", "Python", "JavaScript", "TypeScript", "HTML5", "CSS3", "SQL"] },
  { title: "Frontend Frameworks", items: ["React", "Next.js", "Tailwind CSS", "Liquid (Shopify)", "Responsive Design", "CSS Grid/Flexbox"] },
  { title: "Backend Frameworks", items: ["Spring Boot", "Hibernate", "Node.js", "Express.js", "RESTful APIs", "Microservices"] },
  { title: "Databases", items: ["PostgreSQL", "MySQL", "Oracle DB", "ElasticSearch", "Database Design", "Query Optimization"] },
  { title: "Cloud & DevOps", items: ["AWS Lambda", "API Gateway", "S3", "IAM", "Docker", "Kubernetes", "Git", "Jenkins", "CI/CD"] },
  { title: "Security & APIs", items: ["OAuth2", "JWT", "Tokenisation", "Secure Data Handling", "API Integration", "Third-party APIs"] },
  { title: "E-commerce & CMS", items: ["Shopify", "Payment Integration", "Shipping Logic", "Theme Customization", "E-commerce Workflows"] },
  { title: "Development Practices", items: ["Agile (Scrum)", "TDD", "JUnit", "Integration Testing", "Code Reviews", "Clean Architecture"] },
];
